...
import com.org.kulture.kulture.model.ProductDetailSubSubspinner;
...
public class ProductDetailSubSub extends AppCompatActivity {
    ImageView back_from_productdetails, product_cart;
    ImageView whishlist_off, whishlist_on;
    Spinner spinner;
    String desc, price, item,slug,status;
    ImageView show_image;
    String prename, size = null,qty;
    Double prices;
    ...
    TextView cart_item, updated_price, chargesvalue, qty_value;
    LinearLayout add_to_cart;
    String totalprice, id, image, session,message,cart_counts;
    TextView instockvalue,instockvalue2;
    DecimalFormat two = new DecimalFormat("0.00");
    String pricess, titles, description, img_url, name;
    ProductDetailSubSub activity = null;
    ...
    String stock, weight, upc, novalue;
    ...
    ProductDetailSubSubspinner adapter;
    ProgressBar progress_dailog,progress_dailog2;
    String desc1, desc2, desc3, desc4, desc5,getIMIE,getuid;
    String preid,predesc,preprice,preimage,preslug,pretitle,title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_product_detail_sub_sub);
        id=getIntent().getStringExtra("sub_id");
        image=getIntent().getStringExtra("sub_image");
        name=getIntent().getStringExtra("sub_name");

        price=getIntent().getStringExtra("sub_price");
        desc=getIntent().getStringExtra("sub_desc");
        ...
        product_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ProductDetailSubSub.this, CartActivity.class);
                startActivity(intent);
                ProductDetailSubSub.this.finish();
            }
        });
        activity = this;
     ...
     /*-------------------------------  Add to cart--------------------------------------------- */
        ...
        back_from_productdetails.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProductDetailSubSub.this, ProductDetailSub.class);
        ...
        whishlist_off.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Animation myAnim = AnimationUtils.loadAnimation(ProductDetailSubSub.this, R.anim.bounce);
        ...
        related_card5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ProductDetailSubSub.this, ProductDetailSub.class);
                intent.putExtra("cur_id", String.valueOf(showRelatedIds.get(5)));
        ...
        show_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ProductDetailSubSub.this, ImageFullModeSubSub.class);
                intent.putExtra("sub_id", id);
                intent.putExtra("sub_image", image);
                intent.putExtra("sub_name", name);

                intent.putExtra("sub_price", price);
                intent.putExtra("sub_desc", desc);
                intent.putExtra("cur_id", cur_id);
        ...
        adapter = new ProductDetailSubSubspinner(activity, R.layout.spinner_rows, CustomListViewValuesArr);
