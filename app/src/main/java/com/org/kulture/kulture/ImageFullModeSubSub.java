...
public class ImageFullModeSubSub extends AppCompatActivity {
    ...
    String image,id,price,title,desc,extrasession,prename,session,name;
    ImageView show_logo;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_from_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    Intent intent = new Intent(ImageFullModeSubSub.this, ProductDetailSubSub.class);
                    ...
                    ImageFullModeSubSub.this.finish();
    ...
    private void init() {
        ...
        mPager.setAdapter(new SliderAdapter(ImageFullModeSubSub.this,XMENArray));
