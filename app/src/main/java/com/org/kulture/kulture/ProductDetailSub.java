...
import com.org.kulture.kulture.model.ProductDetailSubspinner;
...
public class ProductDetailSub extends AppCompatActivity {
    ImageView back_from_productdetails, product_cart;
    ImageView whishlist_off, whishlist_on;
    Spinner spinner;
    String desc, price, item;
    ImageView show_image;
    String qty2, prename, size = null;
    Double prices;
    ...
    String stock, weight, upc, novalue,title,qty;
    ...
    ProductDetailSubspinner  adapter;
    ProgressBar progress_dailog,progress_dailog2;
    String desc1, desc2, desc3, desc4, desc5,name,getIMIE,getuid,message,status;
    String preid,predesc,preprice,preimage,preslug,pretitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_product_detail_sub);
        image = getIntent().getStringExtra("cur_image");
        id = getIntent().getStringExtra("cur_id");
        desc=getIntent().getStringExtra("cur_desc");

        price=getIntent().getStringExtra("cur_price");
        name=getIntent().getStringExtra("cur_name");
        ...
        product_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ProductDetailSub.this, CartActivity.class);
                startActivity(intent);
                ProductDetailSub.this.finish();
            }
        });
        activity = this;
    ...
    /*-------------------------------  Add to cart--------------------------------------------- */
        ...
        back_from_productdetails.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProductDetailSub.this, ProductDetail.class);
        ...
        whishlist_off.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Animation myAnim = AnimationUtils.loadAnimation(ProductDetailSub.this, R.anim.bounce);
        ...
        related_card1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProductDetailSub.this, ProductDetailSubSub.class);
                intent.putExtra("sub_id", String.valueOf(showRelatedIds.get(0)));
                intent.putExtra("sub_image",get_related_product_image1.getText().toString());
                intent.putExtra("sub_name",related_product_name1.getText().toString());

                intent.putExtra("sub_price",get_related_product_price1.getText().toString());
                intent.putExtra("sub_desc",get_related_product_desc1.getText().toString());

                intent.putExtra("cur_id", id);
                intent.putExtra("cur_image",image);
                intent.putExtra("cur_desc",desc);

                intent.putExtra("cur_price",price);
                intent.putExtra("cur_name",name);
        ...
        related_card2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ProductDetailSub.this, ProductDetailSubSub.class);
                intent.putExtra("sub_id", String.valueOf(showRelatedIds.get(1)));
                intent.putExtra("sub_image",get_related_product_image2.getText().toString());
                intent.putExtra("sub_name",related_product_name2.getText().toString());

                intent.putExtra("sub_price",get_related_product_price2.getText().toString());
                intent.putExtra("sub_desc",get_related_product_desc2.getText().toString());
        ...
        related_card3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ProductDetailSub.this, ProductDetailSubSub.class);
                intent.putExtra("sub_id", String.valueOf(showRelatedIds.get(2)));
                intent.putExtra("sub_image",get_related_product_image3.getText().toString());
                intent.putExtra("sub_name",related_product_name3.getText().toString());

                intent.putExtra("sub_price",get_related_product_price3.getText().toString());
                intent.putExtra("sub_desc",get_related_product_desc3.getText().toString());
        ...
        related_card4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ProductDetailSub.this, ProductDetailSubSub.class);
                intent.putExtra("sub_id", String.valueOf(showRelatedIds.get(3)));
                intent.putExtra("sub_image",get_related_product_image4.getText().toString());
                intent.putExtra("sub_name",related_product_name4.getText().toString());

                intent.putExtra("sub_price",get_related_product_price4.getText().toString());
                intent.putExtra("sub_desc",get_related_product_desc4.getText().toString());
        ...
        related_card5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ProductDetailSub.this, ProductDetailSubSub.class);
                intent.putExtra("sub_id", String.valueOf(showRelatedIds.get(4)));
                intent.putExtra("sub_image",get_related_product_image5.getText().toString());
                intent.putExtra("sub_name",related_product_name5.getText().toString());

                intent.putExtra("sub_price",get_related_product_price5.getText().toString());
                intent.putExtra("sub_desc",get_related_product_desc5.getText().toString());
        ...
        show_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ProductDetailSub.this, ImageFullModeSub.class);
                intent.putExtra("cur_id", id);
                intent.putExtra("cur_image",image);
                intent.putExtra("cur_desc",desc);
        ...
        adapter = new ProductDetailSubspinner(activity, R.layout.spinner_rows, CustomListViewValuesArr);
    ...
    private class Product_Details_Data extends AsyncTask<String, String, Boolean> {
        ...
        protected void onPostExecute(Boolean aBoolean) {
            try {
                ...
                if(!String.valueOf(stock_quantity).isEmpty()
                        && !String.valueOf(stock_quantity).equals("null")
                        && chargesvalue.getVisibility()!= View.VISIBLE ) {
                    chargesvalue.setVisibility(View.GONE);
                    instockvalue.setText(String.valueOf(stock_quantity)+ " in stock");
                    instockvalue.setVisibility(View.VISIBLE);
                }
